...
async function main() {
  switch (command) {
    ...
    case '--scan':
      console.log('\n🕵️ 开始扫描墓地...\n')
      console.log('⚙️ AI Scanner 已就绪')
      console.log('📝 配置: cemetery.config.example.yaml')
      console.log('💡 运行: npx code-corpses scan --help')
      break
      
    case '--detect':
      console.log('\n🧟 诈尸检测已就绪...')
      console.log('💡 运行: npx code-corpses detect --help')
      break
